...
import './css/Manan.css'

export default class Manan extends Component {
 constructor(props) {
    super(props);
    this.state = {
      city: '',
  ...
  getWeather = () => {
    const apiKey = '6d53fb08e6d809ca89ebdd652a6aed42'; // Replace with your OpenWeatherMap API key
    axios
